        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-10 col-sm-4">
              <p>this is a popular tour in Purwokerto. Explore and enjoy your holiday by checking out our accommodation recommendations</p> 
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="row" style="margin-left:60px;">
                <div class="splide">
                    <div class="splide__track">
                        <div class="splide__list" style="height:500px">
                                    ...
                                    <div class="card-body">
                                      ...
                                      <div class="d-flex justify-content-between align-items-center">
                                        <div class="row">
                                          <div class="col">
                                            <img src="assets/Like.Status.Icon.png" alt="" width="30px" height="30px">
                                            <span class="text-place">Baturraden</span>
                                          </div>
                                          <div class="row">
                                            <div class="col">
                                              <img src="assets/Like.Status.Icon.png" alt="" width="30px" height="30px">
                                    ...
                                    <div class="card-body">
                                      ...
                                      <div class="d-flex justify-content-between align-items-center">
                                        <div class="row">
                                          <div class="col">
                                            <img src="assets/Like.Status.Icon.png" alt="" width="30px" height="30px">
                                            <span class="text-place">Purwokerto</span>
                                          </div>
                                          <div class="row">
                                            <div class="col">
                                              <img src="assets/Like.Status.Icon.png" alt="" width="30px" height="30px">
